			...
			<div className="about-wrapper">
				...
				<div className="about-container flex flex-row justify-center items-center w-full">
					...
					<div className="about-right">
						...
						<p className="text-white">
							Our mission is to make every client feel confident and
							beautiful by providing top-quality hair braiding, hair
							extensions, and hair weaving services. We believe that
							everyone deserves to look and feel their best, and we’re
				...
				<div className="about-bottom py-10 ">
					<h2 className="text-white">
						Come visit us at Kumba Salon and let us help you achieve your
						hair goals!
					</h2>
				</div>
			</div>
