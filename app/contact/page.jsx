          ...
          <div className="flex flex-col space-y-8 justify-between">
            <div>
              ...
              <p className="pt-2 text-cyan-100 text-sm">
                ...
                distinctio nobis possimus accusamus quas sapiente!
              </p>
            </div>
            <div className="flex flex-col space-y-6">
              <div className="inline-flex space-x-2 items-center">
                <IoMdCall size={25} className="text-teal-300" />
                <span className="text-cyan-100">+(90) 538 366 53 05</span>
              </div>
              <div className="inline-flex space-x-2 items-center">
                <MdEmail size={25} className="text-teal-300" />
                <span className="text-cyan-100">alymciabraid@alymcia.com</span>
              </div>
              <div className="inline-flex space-x-2 items-center">
