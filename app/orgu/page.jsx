...
export default function Orgu() {
  ...
  return (
    <div
      ...
      className="pt-[70px] md:pt-[90px] flex flex-col justify-center items-center w-full"
    >
      <div className="my-8 md:my-12">
        <h1 className="px-5 text-sm md:text-2xl  text-white text-center">
      ...
      <div className="grid gap-10 md:grid-cols-2 md:gap-2 lg:gap-8 xl:gap-8 lg:grid-cols-3 items-center">
        {orgu.map((item) => (
          <div key={item.id} className=" flex mb-6 justify-center items-center">
            <div className="flex flex-col mb-8">
              <div className="p-6 text-xl md:text-2xl">
                <h1 className="text-white text-[20px] p-2 md:p-4">
                  {item.title}
                </h1>
              </div>
